...
class ProgressOrders extends AbstractController
{
    /**
     * @Route("/ProgressOrders", name="progressoorders") methods={"GET","POST"}
     */
    public function index()
    {
        ...
        $driverId = $request->request->get('id','drivers id');
        	...
        	$orders = $repository->findBy(['status' => 'Dispatched', 'delivered_by' => $driverId]);
...
                        </tr>';
        foreach($orders as $obj)
        {
            echo    '<tr class="single-order">
                        ...
                        <td><button class="deliver-order">Delivered</button></td>
                    </tr>';
        }
        echo '</table>';
    }
